    ...
    >
      <div className="flex flex-col gap-3">
        <div className="flex gap-3">
          <button
            type="button"
            className={`cursor-pointer rounded-md border-2 p-3 ${selectedCondition === "Mașină nouă" ? "border-[#78FAAE] bg-background-accent" : "border-neutral-600 hover:border-[#78FAAE]"}`}
          ...
          <button
            type="button"
            className={`cursor-pointer rounded-md border-2 p-3 ${selectedCondition === "Mașină rulată" ? "border-[#78FAAE] bg-background-accent" : "border-neutral-600 hover:border-[#78FAAE]"}`}
